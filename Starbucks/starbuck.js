...
function darkmode(){
    ...
    document.querySelector('body').style.backgroundColor = 'rgba(0, 0, 0, 0.86)';
    document.querySelector('h5').style.color = 'white';
    document.querySelector('.navbar').style.backgroundColor = 'black';   
    document.querySelector('.collapse').style.backgroundColor = 'rgba(0, 0, 0, 0.86)';  
    // document.querySelector('#a').style.color = 'white'; 
    for(let i=0; i<=document.querySelectorAll('#a').length-1;i++){
        document.querySelectorAll('#a')[i].style.color = 'white';
    } 
    for(let i=0; i<=1;i++){
        document.querySelectorAll('.fa-solid')[i].style.color = 'white';
        document.querySelectorAll('.fa-solid')[i].style.boder = '1px solid white';
    } 
    for(let i=2; i<=document.querySelectorAll('.fa-solid').length-1;i++){
        document.querySelectorAll('.fa-solid')[i].style.color = 'Green';
    } 
    for(let i=0; i<=document.querySelectorAll('.fa-brands').length-1;i++){
        document.querySelectorAll('.fa-brands')[i].style.color = 'Green';
    }
    for(let i=0;i<=document.querySelectorAll('h1').length-1;i++){
        document.querySelectorAll('h1')[i].style.color = 'green';
    }
    for(let i=0;i<=document.querySelectorAll('h3').length-1;i++){
        document.querySelectorAll('h3')[i].style.color = 'white';
    }
    for(let i=0;i<=document.querySelectorAll('h4').length-1;i++){
        document.querySelectorAll('h4')[i].style.color = 'white';
    }
    for(let i=0;i<=document.querySelectorAll('h5').length-1;i++){
        document.querySelectorAll('h5')[i].style.color = 'white';
    }
    for(let i=0;i<=document.querySelectorAll('span').length-1;i++){
        document.querySelectorAll('span')[i].style.color = 'Green';
    }
    for(let i=0;i<=document.querySelectorAll('p').length-1;i++){
        document.querySelectorAll('p')[i].style.color = 'white';
    }
    for(let i=0;i<=document.querySelectorAll('price').length-1;i++){
        document.querySelectorAll('price')[i].style.color = 'red';
    }
    for(let i=0;i<=document.querySelectorAll('.card').length-1;i++){
        document.querySelectorAll('.card')[i].style.backgroundColor = 'rgba(0, 0, 0, 0.86)';
    }
    for(let i=0;i<=document.querySelectorAll('a').length-1;i++){
        document.querySelectorAll('a')[i].style.color = 'rgba(255, 255, 255, 0.49)';
    }
    for(let i=0;i<=document.querySelectorAll('ul').length-1;i++){
        document.querySelectorAll('ul')[i].style.color = 'white';
    }
}
